                        ...
                        <div class="col-xl-6 col-md-6 mb-4  bg-white">
                            <div class="p-5">
                                ...
                                <div class="text-center">
                                    <h1 class="h3 mb-0 text-gray-800">View Training</h1>
                                </div>
                                <hr>

                                <form class="user needs-validation" novalidate action = "" enctype="multipart/form-data" method = "POST">
                                    <div class="mb-3 row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="course_title" id="course_title" class="form-control" required value="<?= $course_title;?>" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="funding_source" class="form-label">Funding Source</label>
                                        <input type="Text" name="funding_source" id="funding_source" class="form-control" required value="<?= $funding_source;?>" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="start_date" class="form-label">Course Start date</label>
                                        <input type="date" name="start_date" id="start_date" class="form-control" required value="<?= $start_date;?>" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="end_date" class="form-label">Completion date</label>
                                        <input type="date" name="end_date" id="end_date" class="form-control" required value="<?= $end_date;?>"readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="remarks" class="form-label">Remarks</label>
                                        <textarea class="form-control" name="remarks" id="remarks" rows="2" readonly><?= $remarks;?></textarea>
                                    </div>

                                    <a href="./verify_trainings.php" class="btn btn-primary btn-user btn-inline">Back<a>
